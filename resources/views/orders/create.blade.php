        ...
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('orders.store') }}"
                  x-data="{
                      ...
                      taxExempt:        false,
                      taxTimer:         null,
                      billingAddressId: '{{ old('billing_address_id', '') }}',
                      shippingSelection:'{{ old('shipping_address_id', '') }}',
                      lines: [{ product_listing_id: '', unit_price: '', tax_rate: 0, tax_amount: 0, sku: '', stock: '', stockLoading: false }],
                      fees:     [],
                      shipping: '{{ old('shipping', 0) }}',
                      ...
                      lineTax(l)      { return parseFloat(l.tax_amount || 0); },
                      ...
                      async fetchAllLineTax() {
                          ...
                          } catch (e) { console.error('[order/create] calculate-tax failed', e); }
                      },

                      addLine()     { this.lines.push({ product_listing_id: '', unit_price: '', tax_rate: 0, tax_amount: 0, sku: '', stock: '', stockLoading: false }); },
                        ...
                        <table class="min-w-full divide-y divide-gray-100">
                            <thead>
                                <tr class="bg-gray-50/60">
                                    ...
                                    <th class="w-24 px-3 py-2 text-right text-xs font-medium text-gray-400">Tax</th>
                                ...
                                <template x-for="(line, i) in lines" :key="i">
                                    <tr>
                                        ...
                                        <td class="px-3 py-2 text-right">
                                            <span class="text-sm font-semibold text-gray-800" x-text="'$' + fmt(lineSubtotal(line))"></span>
                                        </td>
