...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Add Address</h1>
    ...
    <div class="rounded-lg bg-white p-6 shadow">
        <form method="POST" action="{{ route('portal.addresses.store') }}" class="space-y-5">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="state" value="{{ old('state') }}" placeholder="e.g. TX"
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="country" value="{{ old('country', 'US') }}" maxlength="2"
