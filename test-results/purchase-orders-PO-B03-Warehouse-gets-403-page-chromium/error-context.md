...
- Name: purchase-orders.spec.ts >> PO-B03: Warehouse gets 403 page
- Location: tests/Browser/purchase-orders.spec.ts:30:1
  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e8]:
      - generic [ref=e9]:
        ...
        - textbox "Email" [active] [ref=e11]: warehouse@sale-pro.test
        - list [ref=e12]:
