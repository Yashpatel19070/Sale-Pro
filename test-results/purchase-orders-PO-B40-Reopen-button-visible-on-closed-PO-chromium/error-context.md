...
- Name: purchase-orders.spec.ts >> PO-B40: Reopen button visible on closed PO
- Location: tests/Browser/purchase-orders.spec.ts:190:1
...
Call log:
  - waiting for locator('text=Closed').first()
    - locator resolved to <option value="closed">Closed</option>
