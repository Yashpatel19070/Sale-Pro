...
- Name: purchase-orders.spec.ts >> PO-B50: Search by PO number
- Location: tests/Browser/purchase-orders.spec.ts:202:1
...
Call log:
  - waiting for locator('input[type="search"]')
    - locator resolved to <input type="search" placeholder="Search" class="phpdebugbar-widgets-datasets-search"/>
    - fill("No pu")
