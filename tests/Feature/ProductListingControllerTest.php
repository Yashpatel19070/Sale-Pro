...
use App\Models\User;
use Database\Seeders\ProductListingPermissionSeeder;
...
beforeEach(function () {
    ...
    $this->seed(ProductListingPermissionSeeder::class);
});
...
it('filters listings by product', function () {
    ...
    ProductListing::factory()->forProduct($product)->create(['title' => 'Target Listing']);
...
it('toggleVisibility cycles public to draft', function () {
    $admin = User::factory()->create()->assignRole('admin');
